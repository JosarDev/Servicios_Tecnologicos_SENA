...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "project_pst_sena_at_localhost";
		$data["connName"] = "project_pst_sena at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;project_pst_sena;;1"; //currently unused

		$this->_connectionsIdByName["project_pst_sena at localhost"] = "project_pst_sena_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "project_pst_sena";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=project_pst_sena;OPTION=3";
		// encription set
		...
		$connectionsData["project_pst_sena_at_localhost"] = $data;
