...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("cotizacion" == $this->chrt_array['tables'][0])
			return true;
		if("detalles_cotizacion" == $this->chrt_array['tables'][0])
			return true;
		if("laboratorio" == $this->chrt_array['tables'][0])
			return true;
		if("noticias" == $this->chrt_array['tables'][0])
			return true;
		if("ofertas" == $this->chrt_array['tables'][0])
			return true;
		if("servicios" == $this->chrt_array['tables'][0])
			return true;
		if("solicitudes" == $this->chrt_array['tables'][0])
			return true;
