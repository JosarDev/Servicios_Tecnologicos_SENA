...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "project_pst_sena_at_localhost";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	$projectEntitiesReverse[ "cotizacion" ] = "cotizacion";
	$projectEntities[ "detalles_cotizacion" ] = array( "url" => "detalles_cotizacion", "type" => 0 );
	$projectEntitiesReverse[ "detalles_cotizacion" ] = "detalles_cotizacion";
	$projectEntities[ "laboratorio" ] = array( "url" => "laboratorio", "type" => 0 );
	$projectEntitiesReverse[ "laboratorio" ] = "laboratorio";
	$projectEntities[ "noticias" ] = array( "url" => "noticias", "type" => 0 );
	$projectEntitiesReverse[ "noticias" ] = "noticias";
	$projectEntities[ "ofertas" ] = array( "url" => "ofertas", "type" => 0 );
	$projectEntitiesReverse[ "ofertas" ] = "ofertas";
	$projectEntities[ "servicios" ] = array( "url" => "servicios", "type" => 0 );
	$projectEntitiesReverse[ "servicios" ] = "servicios";
	$projectEntities[ "solicitudes" ] = array( "url" => "solicitudes", "type" => 0 );
	$projectEntitiesReverse[ "solicitudes" ] = "solicitudes";
