...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "project_pst_sena_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "calibracion", "varname" => "project_pst_sena_at_localhost__calibracion", "altvarname" => "calibracion", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "casos_exito", "varname" => "project_pst_sena_at_localhost__casos_exito", "altvarname" => "casos_exito", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "centros", "varname" => "project_pst_sena_at_localhost__centros", "altvarname" => "centros", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "cliente", "varname" => "project_pst_sena_at_localhost__cliente", "altvarname" => "cliente", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "cotizacion", "varname" => "project_pst_sena_at_localhost__cotizacion", "altvarname" => "cotizacion", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "departamento", "varname" => "project_pst_sena_at_localhost__departamento", "altvarname" => "departamento", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "descripcion_servicios", "varname" => "project_pst_sena_at_localhost__descripcion_servicios", "altvarname" => "descripcion_servicios", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "detalles_cotizacion", "varname" => "project_pst_sena_at_localhost__detalles_cotizacion", "altvarname" => "detalles_cotizacion", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "detalles_servico", "varname" => "project_pst_sena_at_localhost__detalles_servico", "altvarname" => "detalles_servico", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "ensayo", "varname" => "project_pst_sena_at_localhost__ensayo", "altvarname" => "ensayo", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "fabricante", "varname" => "project_pst_sena_at_localhost__fabricante", "altvarname" => "fabricante", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "instrumento", "varname" => "project_pst_sena_at_localhost__instrumento", "altvarname" => "instrumento", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "laboratorio", "varname" => "project_pst_sena_at_localhost__laboratorio", "altvarname" => "laboratorio", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "nodos", "varname" => "project_pst_sena_at_localhost__nodos", "altvarname" => "nodos", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "noticias", "varname" => "project_pst_sena_at_localhost__noticias", "altvarname" => "noticias", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "ofertas", "varname" => "project_pst_sena_at_localhost__ofertas", "altvarname" => "ofertas", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "servicios", "varname" => "project_pst_sena_at_localhost__servicios", "altvarname" => "servicios", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "solicitudes", "varname" => "project_pst_sena_at_localhost__solicitudes", "altvarname" => "solicitudes", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "tipo_material", "varname" => "project_pst_sena_at_localhost__tipo_material", "altvarname" => "tipo_material", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "tiposervicio", "varname" => "project_pst_sena_at_localhost__tiposervicio", "altvarname" => "tiposervicio", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			$dalTables[$conn->connId][] = array("name" => "usuario", "varname" => "project_pst_sena_at_localhost__usuario", "altvarname" => "usuario", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
		}
	}
