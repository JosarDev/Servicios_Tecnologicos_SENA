	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "project_pst_sena_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "centro", "varname" => "project_pst_sena_at_localhost__centro", "altvarname" => "centro", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
			...
			$dalTables[$conn->connId][] = array("name" => "municipio", "varname" => "project_pst_sena_at_localhost__municipio", "altvarname" => "municipio", "connId" => "project_pst_sena_at_localhost", "schema" => "", "connName" => "project_pst_sena at localhost");
