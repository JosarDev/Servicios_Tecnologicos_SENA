...
$dalTablecentro["Departamento"] = array("type"=>200,"varname"=>"Departamento", "name" => "Departamento", "autoInc" => "0");
$dalTablecentro["Municipio"] = array("type"=>200,"varname"=>"Municipio", "name" => "Municipio", "autoInc" => "0");
$dalTablecentro["Celular"] = array("type"=>200,"varname"=>"Celular", "name" => "Celular", "autoInc" => "0");
