...
require_once("include/detalles_cotizacion_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "detalles_cotizacion" );
